    ...
    return ( 
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="input-container">
                <Input type="text" label="Display Name" data={user.name} setData={setName}/>
                <Input type="text" label="Age" data={user.age} setData={setAge}/>
                <Input inputType="textarea" label="About" data={user.about} setData={setAbout}/>
            </div>
